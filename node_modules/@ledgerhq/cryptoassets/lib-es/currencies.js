 ...
 */
export function listCryptoCurrencies(withDevCrypto, withTerminated) {
 ...
 * @param {*} f
 */
export function findCryptoCurrency(f) {
 ...
 * @param {*} scheme
 */
export function findCryptoCurrencyByScheme(scheme) {
 ...
 * @param {*} ticker
 */
export function findCryptoCurrencyByTicker(ticker) {
 ...
 * @param {*} id
 */
export function findCryptoCurrencyById(id) {
 ...
 * @param {*} keyword
 */
export var findCryptoCurrencyByKeyword = function (keyword) {
 ...
 * @param {*} id
 */
export var hasCryptoCurrencyId = function (id) {
 ...
 * @param {*} id
 */
export function getCryptoCurrencyById(id) {
