...
exports.getCryptoCurrencyById = exports.hasCryptoCurrencyId = exports.findCryptoCurrencyByKeyword = exports.findCryptoCurrencyById = exports.findCryptoCurrencyByTicker = exports.findCryptoCurrencyByScheme = exports.findCryptoCurrency = exports.listCryptoCurrencies = exports.registerCryptoCurrency = void 0;
...
var ethereumUnits = function (name, code) { return [
    {
        name: name,
        code: code,
        magnitude: 18
...
var cryptocurrenciesByTicker = {};
var cryptocurrenciesArray = [];
var prodCryptoArray = [];
var cryptocurrenciesArrayWithoutTerminated = [];
var prodCryptoArrayWithoutTerminated = [];
for (var id in cryptocurrenciesById) {
    var definition = cryptocurrenciesById[id];
 ...
 */
function listCryptoCurrencies(withDevCrypto, withTerminated) {
    if (withDevCrypto === void 0) { withDevCrypto = false; }
    if (withTerminated === void 0) { withTerminated = false; }
 ...
 * @param {*} f
 */
function findCryptoCurrency(f) {
    return cryptocurrenciesArray.find(f);
}
exports.findCryptoCurrency = findCryptoCurrency;
/**
 *
 * @param {*} scheme
 */
function findCryptoCurrencyByScheme(scheme) {
    return cryptocurrenciesByScheme[scheme];
}
exports.findCryptoCurrencyByScheme = findCryptoCurrencyByScheme;
/**
 *
 * @param {*} ticker
 */
function findCryptoCurrencyByTicker(ticker) {
    return cryptocurrenciesByTicker[ticker];
}
exports.findCryptoCurrencyByTicker = findCryptoCurrencyByTicker;
/**
 *
 * @param {*} id
 */
function findCryptoCurrencyById(id) {
 ...
 * @param {*} keyword
 */
var findCryptoCurrencyByKeyword = function (keyword) {
    var r = findCryptoCurrency(function (c) {
 ...
 * @param {*} id
 */
var hasCryptoCurrencyId = function (id) {
    return id in cryptocurrenciesById;
};
...
function getCryptoCurrencyById(id) {
    var currency = findCryptoCurrencyById(id);
    if (!currency) {
        throw new Error("currency with id \"".concat(id, "\" not found"));
    }
    return currency;
}
