...
function network() {
  ...
  onboard.app.subscribe(function (_ref) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              if (!(!networkCheckRequested && stateStore.network.get() != appNetworkId && onboard.getProviderName(wallet === null || wallet === void 0 ? void 0 : wallet.provider) !== 'WalletConnect')) {
                _context2.next = 14;
                break;
              }
                        ...
                        while (1) {
                          switch (_context.prev = _context.next) {
                            ...
                            case 9:
                              ...
                              onboard.app.update(function (store) {
