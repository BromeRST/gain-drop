...
var getSafe = function getSafe(sdk) {
  return Promise.race([sdk.safe.getInfo(), // Timeout need as this method hangs until it can find the safe info
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return new Promise(function (resolve) {
              resolve(_interopNamespace(require('@gnosis.pm/safe-apps-sdk')));
            });
  ...
  return {
    ...
    wallet: function () {
      var _wallet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref2) {
        var createModernProviderInterface, sdk, _yield$Promise, SafeAppProvider, safe, provider;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 7;
                return new Promise(function (resolve) {
                  resolve(_interopNamespace(require('@gnosis.pm/safe-apps-provider')));
                });

              case 7:
                _yield$Promise = _context2.sent;
                SafeAppProvider = _yield$Promise.SafeAppProvider;
                _context2.next = 11;
                return getSafe(sdk);
...
exports.checkGnosisSafeContext = checkGnosisSafeContext;
