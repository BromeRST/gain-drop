...
function _keystoneProvider() {
  _keystoneProvider = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(options) {
    var _yield$Promise, Transaction, _yield$Promise2, Common, _yield$Promise3, createProvider, BASE_PATH, networkId, rpcUrl, BigNumber, networkName, customNetwork, keyring, dPath, addressToIndex, enabled, customPath, provider, disconnect, setPath, _setPath, isCustomPath, enable, addresses, generateAccountsMap, setPrimaryAccount, getPrimaryAddress, getMoreAccounts, _getMoreAccounts, _getAccounts, _getAccounts2, getBalances, getBalance, _signTransaction, _signTransaction2, _signMessage, _signMessage2, _signTypedMessage, _signTypedMessage2;
        ...
        switch (_context12.prev = _context12.next) {
          case 0:
            _signTypedMessage2 = function _signTypedMessage4() {
              _signTypedMessage2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(_ref6) {
                var data;
                  ...
                  while (1) {
                    switch (_context8.prev = _context8.next) {
                      ...
                      case 2:
                        ...
                        return _context8.abrupt("return", addresses());

                      case 4:
                        _context8.prev = 4;
                        _context8.next = 7;
                        return keyring.addAccounts(5);
            ...
            setPrimaryAccount = function _setPrimaryAccount(address) {
              ...
              var accounts = _toConsumableArray(addressToIndex.entries());

              var account = accounts.find(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 1),
                    accountAddress = _ref2[0];

                return accountAddress === address;
              });
              var accountIndex = accounts.findIndex(function (_ref3) {
                var _ref4 = _slicedToArray(_ref3, 1),
                    accountAddress = _ref4[0];

                return accountAddress === address;
              });
              keyring.setCurrentAccount((account === null || account === void 0 ? void 0 : account[1]) || 0); // pull the item at the account index out of the array and place at the front
            ...
            generateAccountsMap = function _generateAccountsMap(accounts) {
              var _map = new Map();
